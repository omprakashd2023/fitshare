...
import '../../common/widgets/workout_row.dart';
...
class _HomeViewState extends ConsumerState<HomeView> {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Set your Goal to personalize your feeds.",
                                  style: TextStyle(
                                    color: TColor.black,
                                    fontSize: 13,
                                    fontWeight: FontWeight.w500,
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    getBMIStatus(double.parse(user.weight!),
  ...
  String getBMIStatus(double weight, double height) {
  ...
  List<PieChartSectionData> showingSections(double weight, double height) {
    double bmi = calculateBMI(weight, height);
