...
import '../../common/widgets/setting_row.dart';
import '../../common/widgets/title_subtitle_cell.dart';
...
class _ProfileViewState extends ConsumerState<ProfileView> {
  ...
  Widget build(BuildContext context) {
    ...
    final userAge = user.calculateAge();
    return Scaffold(
      appBar: AppBar(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          goalArr[user.goalIndex ?? 0]["title"],
                          style: TextStyle(
                            color: TColor.gray,
                            fontSize: 12,
                          ),
